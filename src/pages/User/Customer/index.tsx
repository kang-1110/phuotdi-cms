...
import UserCardItem from '@/components/UserInfoCard/UserInfoCard';
...
const Customer = () => {
    ...
    return (
        <div>
            ...
            {openMode.isOpen && <UserCreate pageName="Khách hàng" isEdit={openMode.isEdit} open={openMode.isOpen} setOpen={(open) => setOpenMode({...openMode, isOpen: open})} />}
        </div>
    )
